...
public class MassFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String[] lengthUnits = getResources().getStringArray(R.array.mass_units);
    ...
    private void calculateResult(String from, String to, String value) {
        ...
        if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[0] + getResources().getStringArray(R.array.mass_units)[1]))
            resultValue = givenValue / 1000f;
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[0] + getResources().getStringArray(R.array.mass_units)[2]))
            resultValue = givenValue / (2.71f+6);
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[0] + getResources().getStringArray(R.array.mass_units)[3]))
            resultValue = givenValue / 453592f;

        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[1] + getResources().getStringArray(R.array.mass_units)[0]))
            resultValue = givenValue * 1000f;
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[1] + getResources().getStringArray(R.array.mass_units)[2]))
            resultValue = givenValue / 1000f;
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[1] + getResources().getStringArray(R.array.mass_units)[3]))
            resultValue = givenValue / 454f;

        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[2] + getResources().getStringArray(R.array.mass_units)[0]))
            resultValue = givenValue * (2.71f+6);
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[2] + getResources().getStringArray(R.array.mass_units)[1]))
            resultValue = givenValue * 1000f;
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[2] + getResources().getStringArray(R.array.mass_units)[3]))
            resultValue = givenValue * 2.205f;


        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[3] + getResources().getStringArray(R.array.mass_units)[0]))
            resultValue = givenValue * 453592f;
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[3] + getResources().getStringArray(R.array.mass_units)[1]))
            resultValue = givenValue * 454f;
        else if ((from + to).equalsIgnoreCase(getResources().getStringArray(R.array.mass_units)[3] + getResources().getStringArray(R.array.mass_units)[2]))
            resultValue = givenValue / 2.205f;
